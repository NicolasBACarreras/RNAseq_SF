...
cd /home/bsc/bsc008978/Box/pipelines/RNAseq_SF/results/tmp/quality_trimming/quality_trimming_RNA

SECONDS=0

touch /home/bsc/bsc008978/Box/pipelines/RNAseq_SF/results/tmp/quality_trimming/quality_trimming_RNA/.running
rm -f /home/bsc/bsc008978/Box/pipelines/RNAseq_SF/results/tmp/quality_trimming/quality_trimming_RNA/.error

trap 'error_handler $LINENO $?' ERR

error_handler() {
    echo $SECONDS > /home/bsc/bsc008978/Box/pipelines/RNAseq_SF/results/tmp/quality_trimming/quality_trimming_RNA/.error
    rm -f /home/bsc/bsc008978/Box/pipelines/RNAseq_SF/results/tmp/quality_trimming/quality_trimming_RNA/.running
    exit 1
}

DONE_FILE=/home/bsc/bsc008978/Box/pipelines/RNAseq_SF/results/tmp/quality_trimming/quality_trimming_RNA/.done
 ...
 2> /home/bsc/bsc008978/Box/pipelines/RNAseq_SF/results/tmp/quality_trimming/quality_trimming_RNA/.command.err 1> /home/bsc/bsc008978/Box/pipelines/RNAseq_SF/results/tmp/quality_trimming/quality_trimming_RNA/.command.out && echo $SECONDS > $DONE_FILE
